	...
	<form action="./php/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Código de barra</label>
				  	<input class="input" type="text" name="producto_codigo" pattern="[a-zA-Z0-9- ]{1,70}" maxlength="70" required value="<?php echo $datos['producto_codigo']; ?>" readonly="readonly">
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		...
		<div class="columns">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Stock</label>
				  	<input class="input" type="text" name="producto_stock" pattern="[0-9]{1,25}" maxlength="25" required value="<?php echo $datos['producto_stock']; ?>" readonly="readonly" >
				</div>
		  	</div>
			...
			<div class="column">
		    	<div class="control">
					<label>Agregar producto</label>
				  	<input class="input" type="text" name="agregar" maxlength="25" required value="<?php echo 0 ?>" >
				</div>
		  	</div>
			  <div class="column">
		    	<div class="control">
					<label>Quitar producto</label>
				  	<input class="input" type="text" name="quitar" maxlength="25" required value="<?php echo 0; ?>" >
				</div>
		  	</div>
		  	<div class="column">
