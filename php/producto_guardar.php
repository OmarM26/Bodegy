<?php
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO producto(producto_codigo,producto_nombre,producto_stock,producto_foto,categoria_id,usuario_id) VALUES(:codigo,:nombre,:stock,:foto,:categoria,:usuario)");
